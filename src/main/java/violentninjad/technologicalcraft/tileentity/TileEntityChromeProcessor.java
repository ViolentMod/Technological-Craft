package violentninjad.technologicalcraft.tileentity;
...
public class TileEntityChromeProcessor extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity() {
        ...
        if (flag != this.furnaceBurnTime > 0) {
            flag1 = true;
            BlockChromeProcessor.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            ...
            ItemStack itemstack = ChromeProcessorRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public static int getItemBurnTime(ItemStack itemstack){
        if(itemstack == null){
            ...
            if(item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air){
                ...
                if(block == ModBlocks.chromeBlock){
                    return 200;
                }
            ...
            if(item == ModItems.chromeIngot) return 1600;
